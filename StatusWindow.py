...
def status_window():
    ...
    layout = [[sg.Text('Name:'), cname, sg.ReadFormButton('Choose Name')],  # Layout for the status window
              ...
              [sg.Text('STR:', size=(5, 1)),
               sg.Spin([i for i in range(0, 101)], initial_value=0, key='STR', size=(5, 1), change_submits=True)],
              [sg.Text('INT:', size=(5, 1)),
               sg.Spin([i for i in range(0, 101)], initial_value=0, key='INT', size=(5, 1), change_submits=True)],
              [sg.Text('DEX:', size=(5, 1)),
               sg.Spin([i for i in range(0, 101)], initial_value=0, key='DEX', size=(5, 1), change_submits=True)],
